...
public class EmployeeService {
    ...
    public ResponseEntity<String> authenticateEmployee(String firstName, String lastName, HttpServletResponse response) {
        Optional<List<Employee>> existingEmployee = employeeRepository.findByFirstNameAndLastName(
            firstName, lastName
        );
        ...
        Employee foundEmployee = existingEmployee.get().get(0);
